...
`ux-ui-review` là skill dùng để review flow, layout, interaction, visual hierarchy, accessibility, responsive behavior, state, form, hoặc usability risk. Trang này giúp bạn mở source thật, nhận ra pattern, và copy skill khi cần so sánh với project khác.

Nguồn: [`.claude/skills/ux-ui-review/SKILL.md`](https://github.com/VuNguyentranThe/agent-config/blob/master/.claude/skills/ux-ui-review/SKILL.md)

## Điểm đáng chú ý

- Dùng khi có UI hiện có cần đánh giá.
- Xem xét clarity, consistency, accessibility basics, và trạng thái UI.
- Dùng Figma MCP khi có link thiết kế.
