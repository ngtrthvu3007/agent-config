...
const viSidebar = [
    ...
    items: [
      ...
      { text: 'CLAUDE.md', link: '/claude' },
      {
        ...
        items: [
          ...
          { text: 'Tạo rule mới', link: '/guide/create-rule' },
        ],
      },
      {
        text: 'Skills',
  ...
  },
  {
    text: 'Tài nguyên',
    items: [
      { text: 'Tài liệu tham khảo', link: '/references' },
    ],
  },
]
...
export default defineConfig({
  base,
  title: 'Agent Config',
  description: 'Bộ cấu hình mẫu cho AI coding agents — Claude Code và ChatGPT Codex',
  ...
  locales: {
    ...
    en: {
      ...
      lang: 'en-US',
      title: 'Agent Config',
      description: 'Configuration template for AI coding agents — Claude Code and ChatGPT Codex',
      themeConfig: {
        nav: enNav,
        sidebar: enSidebar,
        editLink: false,
