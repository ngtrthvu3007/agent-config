...
`review-solution` is the skill for evaluating a solution, idea, proposal, or technical direction. This page helps you open the real source, notice the pattern, and copy the skill when comparing it with another project.

Source: [`.claude/skills/review-solution/SKILL.md`](https://github.com/VuNguyentranThe/agent-config/blob/master/.claude/skills/review-solution/SKILL.md)

## What To Notice

- Focuses on feasibility, tradeoffs, risks, and recommendation.
- Useful before planning or implementation when the direction is uncertain.
- Does not replace `review-diff` or `review-technical`.
