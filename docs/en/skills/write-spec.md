...
`write-spec` is the skill for turning an idea, epic, or user story into an implementation-ready spec. This page helps you open the real source, notice the pattern, and copy the skill when comparing it with another project.

Source: [`.claude/skills/write-spec/SKILL.md`](https://github.com/VuNguyentranThe/agent-config/blob/master/.claude/skills/write-spec/SKILL.md)

## What To Notice

- Creates scope, non-goals, acceptance criteria, edge cases, and approval points.
- Reads templates in `docs/specs/` before writing.
- Saves output under `docs/specs/` in the repo format.
