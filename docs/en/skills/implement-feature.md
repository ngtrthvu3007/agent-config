...
`implement-feature` is the skill for clear-scope work that needs code changes. This page helps you open the real source, notice the pattern, and copy the skill when comparing it with another project.

Source: [`.claude/skills/implement-feature/SKILL.md`](https://github.com/VuNguyentranThe/agent-config/blob/master/.claude/skills/implement-feature/SKILL.md)

## What To Notice

- Keeps changes focused and follows existing patterns.
- Reads relevant technical rules before editing.
- Runs the smallest suitable verification before reporting.
