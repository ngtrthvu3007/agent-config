...
`write-tests` is the skill for adding or improving tests for behavior, contracts, bugs, or regressions. This page helps you open the real source, notice the pattern, and copy the skill when comparing it with another project.

Source: [`.claude/skills/write-tests/SKILL.md`](https://github.com/VuNguyentranThe/agent-config/blob/master/.claude/skills/write-tests/SKILL.md)

## What To Notice

- Focuses on behavior and meaningful assertions.
- Prefers small fixtures and avoids overfitting to implementation details.
- Runs relevant tests and reports results clearly.
