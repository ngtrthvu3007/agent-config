...
`security-review` is the skill for auth, authorization, permissions, tokens, cookies, secrets, payment, or private data work. This page helps you open the real source, notice the pattern, and copy the skill when comparing it with another project.

Source: [`.claude/skills/security-review/SKILL.md`](https://github.com/VuNguyentranThe/agent-config/blob/master/.claude/skills/security-review/SKILL.md)

## What To Notice

- Focuses on risk, access control, data exposure, and approval gates.
- Useful for endpoints, services, guards, or sensitive flows.
- Prefers small, auditable fixes and avoids changing sensitive behavior without approval.
