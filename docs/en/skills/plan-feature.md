...
`plan-feature` is the skill for turning a requirement into an implementation plan before editing code. This page helps you open the real source, notice the pattern, and copy the skill when comparing it with another project.

Source: [`.claude/skills/plan-feature/SKILL.md`](https://github.com/VuNguyentranThe/agent-config/blob/master/.claude/skills/plan-feature/SKILL.md)

## What To Notice

- Does not edit code; focuses on scope, steps, acceptance criteria, verification, and risks.
- Reads `docs/specs/`, `docs/domain/`, and `docs/engineering/` before planning.
- Calls out approval gates before schema, API, auth, payment, secrets, infrastructure, or dependency changes.
