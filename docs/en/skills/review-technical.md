...
`review-technical` is the skill for reviewing technical quality of a specified file, module, component, service, or endpoint. This page helps you open the real source, notice the pattern, and copy the skill when comparing it with another project.

Source: [`.claude/skills/review-technical/SKILL.md`](https://github.com/VuNguyentranThe/agent-config/blob/master/.claude/skills/review-technical/SKILL.md)

## What To Notice

- Does not depend on a git diff; useful for reviewing a specific code area.
- Focuses on maintainability, architecture fit, performance, TypeScript, and test quality.
- Does not edit files when only asked to review.
